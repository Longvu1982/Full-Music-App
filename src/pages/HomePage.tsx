  ...
  const HomePageElement: React.FC<{ isLoading: boolean }> = ({ isLoading }) => {
    ...
    return (
      <div className="w-full text-white">
        {(isLoading ? Array.from(new Array(5)) : homeDetails).map(
          (homeDetailsItem: any, homeDetailsIndex: number) => {
            return (
                  ...
                  {(homeDetailsItem?.items
                    ...
                    return item ? (
                      ...
                      >
                        ...
                        <p className="line-clamp-2 text-lighter_text_color">
                      ...
                      <div
                        key={index}
                        className="w-[calc((100%_-_64px)/5)] aspect-square"
                      >
                        <Skeleton
                          variant="rectangular"
                          width="100%"
