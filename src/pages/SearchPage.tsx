        ...
        {(videos && videos?.length > 0
          ...
          return item ? (
            <div
              ...
              className="group relative cursor-pointer flex flex-col flex-wrap gap-6 w-full md:w-[calc((100%-16px)/2)] lg:w-[calc((100%-32px)/3)] xl:w-[calc((100%-48px)/4)]"
            >
            ...
            <div className="w-full md:w-[calc((100%-16px)/2)] lg:w-[calc((100%-32px)/3)] xl:w-[calc((100%-48px)/4)] aspect-video">
  ...
  return (
    <>
      ...
      <div className="flex flex-wrap gap-4 mb-10">
        {(songs && songs.length > 0 ? songs : Array.from(new Array(6)))?.map(
          (item: any, index: number) => (
            <div
              ...
              } h-16 cursor-pointer hover:bg-third border-b-[0.5px] border-b-border_color items-center w-full md:w-[calc((100%-16px)/2)] shrink-0 grow-0 px-4 text-lighter_text_color font-semibold`}
            >
              <MusicCard item={item} />
            </div>
          )
      ...
      <div className="flex gap-8 mb-10">
        {TabButons?.map((item) => {
          return (
            ...
            >
              <h1
                className={`hover:brightness-110 pb-1 text-lg text-title_color ${
                  item.id === activeIndex ? "border-b-2 border-b-[#1976d2]" : ""
                }`}
              >
                {item.name}
              </h1>
