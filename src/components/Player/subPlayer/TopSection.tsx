...
const PopUp: React.FC = () => {
  return (
    <div onClick={(e) => e.stopPropagation()} className="text-xs flex items-center justify-center absolute z-20 w-24 h-8 hover:brightness-110 bg-third  right-0 -translate-y-12 -translate-x-4 rounded-md rounded-br-none">
...
const TopSection = () => {
  ...
  return (
    <div className="flex justify-between items-center mb-6">
      ...
      <div onClick={() => setShowPopUP(!isShowPopUp)} className="relative w-9 h-9 flex justify-center items-center cursor-pointer hover:bg-primary rounded-full">
